...
function assert(cond, msg) {
    if (cond) { passed++; logger.info('  ✅ ' + msg); }
    else { failed++; logger.info('  ❌ FAIL: ' + msg); }
}

async function runTests() {
    logger.info('─── EXECUTORS Registry ───');
    ...
    logger.info('─── Execute: Unknown Component ───');
