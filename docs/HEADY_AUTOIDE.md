...
- Never emit drive letters, localhost, raw Render domains, or private IPs

When precise references are needed for engineers:
- Refer to internal dev hosts as manager.dev.local.heady.internal:3300
- Never use C:\, F:\, or .onrender.com references

## Strictly Prohibited in Any Shared Surface
- Windows drive paths (C:\..., F:\...)
- Third-party domains (.onrender.com, .vercel.app, etc.)
- Localhost and raw IP addresses
