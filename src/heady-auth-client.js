...
class HeadyAuth {
  ...
  #syncAutoContext() {
    ...
    window.HeadyAutoContext.set('auth:ready', this.#ready);
    window.HeadyAutoContext.set('auth:user', this.#user);
    window.HeadyAutoContext.set('auth:leadId', this.#leadId);

    this.on('auth:change', ({ user }) => {
      window.HeadyAutoContext.set('auth:user', user);
      window.HeadyAutoContext.set('auth:authenticated', !!user);
    });
  }
